...
TOPICS = [
    ...
    ['Очаровательном', 'скажи мне оригинальный комплимент'],
    ['Очаровательном', 'сделай мне комплимент про хорошее чувство юмора'],
    ['Очаровательном', 'сделай мне комплимент о моей красоте'],
    ['Юмористическом и Очаровательном', 'придумай смешной комплимент для девушки'],
    ['Дружелюбном и Успокаивающем', 'расскажи о том, как важно быть любимой'],
    ...
    ['Дружелюбном', 'скажи, что Жизнь замечательная!'],
